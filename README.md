...
| &nbsp;&nbsp;&nbsp;&nbsp;source      | It is the folder where every software solution is placed. It represents one executable Python file per solution.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |   |
| &nbsp;&nbsp;&nbsp;&nbsp;test        | The folder where all the files are to be respectively read and used as raw material are placed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |   |
